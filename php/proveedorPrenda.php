...
<head>
    ...
    $_SESSION['nav_section'] = 'ProveedorPrendas';
...
<body>
    ...
    <div class="container">
        <div class="row my-3">
            <div class="row-3">
                <a href="./proveedores prendas/add.php">
        ...
        <div class="row">
            ...
            <table class="table table-hover">
                ...
                <?php
                $db->query("SELECT * FROM proveedor_prenda;");
...
';
                    ...
                    <tr>
      <th scope="row">' . $proveedor['id_proveedor_prenda'] . '</th>
      <td>' . $proveedor['proveedor_prenda'] . ' </td>
